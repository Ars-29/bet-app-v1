...
const LoginDialog = ({ children, ...props }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen} {...props}>
            ...
            <DialogContent className="sm:max-w-md w-full max-w-[90%] p-0 gap-0 rounded-lg overflow-hidden border-0 shadow-lg">
                {/* Header */}
                                    ...
                                    <FormItem className="">
                                        ...
                                        <FormControl>
                                            <Input
                                                ...
                                                className="h-10 border border-black rounded-none text-black focus:border-black focus-visible:border-black focus:ring-0 focus-visible:ring-0"
                                                {...field}
                                            />
                    ...
                    <div className="mt-5 pt-4 border-t border-gray-200">
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    setIsOpen(false)
                                    // Handle register modal opening logic here
                                }}
                            >
                                Register now
                            </Button>
